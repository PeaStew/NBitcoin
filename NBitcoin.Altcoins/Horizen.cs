...
{
	// Reference: https://github.com/zencashofficial/zen/blob/master/src/chainparams.cpp
	public class Horizen : NetworkSetBase
    {
        public static Horizen Instance { get; } = new Horizen();

        public override string CryptoCode => "zen";

        private Horizen()
        {

        }
        public class HorizenConsensusFactory : ConsensusFactory
        {
            private HorizenConsensusFactory()
            {
            }
            public static HorizenConsensusFactory Instance { get; } = new HorizenConsensusFactory();

            public override BlockHeader CreateBlockHeader()
            {
                return new HorizenBlockHeader();
            }
            public override Block CreateBlock()
            {
                return new HorizenBlock(new HorizenBlockHeader());
            }
        }

#pragma warning disable CS0618 // Type or member is obsolete

        public class HorizenBlock : Block
        {
            public HorizenBlock(HorizenBlockHeader header) : base(header)
            {
            ...
            {
                return HorizenConsensusFactory.Instance;
            }
        }
        public class HorizenBlockHeader : BlockHeader
        {
        ...
        {
            RegisterDefaultCookiePath("Horizen");
            // Alternatively,
            /*
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            builder.SetConsensus(new Consensus()
            {
                ...
                PowTargetTimespan = TimeSpan.FromSeconds(3.5 * 24 * 60 * 60), //TODO ? - maxTipAge = 24 * 60 * 60
            ...
            .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS, new byte[] { 0x20, 0x89 })
            .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS_OLD, new byte[] { 0x1C, 0xB8 })
			.SetBase58Bytes(Base58Type.SCRIPT_ADDRESS, new byte[] { 0x20, 0x96 })
            .SetBase58Bytes(Base58Type.SCRIPT_ADDRESS_OLD, new byte[] { 0x1C, 0xBD })
            ...
            .SetName("zen-main")
            .AddAlias("zen-mainnet")
            .AddAlias("Horizen-mainnet")
            .AddAlias("Horizen-main")
            .AddDNSSeeds(new[]
            {
				new DNSSeedData("dnsseed.horizen.global", "dnsseed.horizen.global"),
				new DNSSeedData("dnsseed.zensystem.io", "dnsseed.zensystem.io"),
				new DNSSeedData("mainnet.horizen.global", "mainnet.horizen.global"),
				new DNSSeedData("mainnet.zensytem.io", "mainnet.zensytem.io"),
				new DNSSeedData("node1.zenchain.info", "node1.zenchain.info"),
            })
        ...
        protected override NetworkBuilder CreateTestnet()
        {
            ...
            .SetMaxP2PVersion(170002)
            .SetName("zen-test")
            .AddAlias("zen-testnet")
            .AddAlias("Horizen-test")
            .AddAlias("Horizen-testnet")
            .AddDNSSeeds(new[]
            {
                new DNSSeedData("Horizen.org", "dnsseed.testnet.Horizen.org")
            })
            .AddSeeds(new NetworkAddress[0])
        ...
        protected override NetworkBuilder CreateRegtest()
        {
            ...
            .SetMaxP2PVersion(170002)
            .SetName("zen-reg")
            .AddAlias("zen-regtest")
            .AddAlias("Horizen-reg")
            .AddAlias("Horizen-regtest")
